"""Generate macOS DMG background PNG for 有秋 (Yield).
...
def make_background() -> None:
    ...
    draw.text((wx(42), wy(34)), "有秋 · Yield", fill=TEXT, font=load_font(22, bold=True))
    draw.text((wx(42), wy(62)), "服田力穑，乃亦有秋 · 本地优先的个人成长与行动工具", fill=TEXT_MUTED, font=load_font(13))
