...
const SNOOZE_KEY = "youqiu.version-update-snooze";
...
export function VersionUpdateNotice() {
  ...
  return <aside className="version-update-notice" role="dialog" aria-label="发现新版本" aria-live="polite">
    ...
    <div className="version-update-copy"><span>发现新版本</span><h3>有秋 v{update.latestVersion}</h3><p>{notes}</p><small>当前 v{update.currentVersion} · 来自 {update.source}</small></div>
